...
pub struct ClaimEscrow<'info> {
    ...
    pub recieves_initializer_token: Account<'info, TokenAccount>,
    ...
    pub reciever_reciever_token: Account<'info, TokenAccount>,
    ...
    pub recieves_reciever_token: Account<'info, TokenAccount>,
    ...
    pub fee_collector_initializer_account: Account<'info, TokenAccount>,
    ...
    pub fee_collector_reciever_account: Account<'info, TokenAccount>,
...
impl<'info> ClaimEscrow<'info> {
    pub fn claim(ctx: Context<ClaimEscrow>) -> Result<()> {
        ...
        // let reciever_fee = (escrow.receiver_amount as u128)
        //     .checked_mul(escrow.fee_basis_point as u128)
        //     .unwrap()
        //     .checked_div(10000)
        //     .unwrap() as u64;
        ...
        let initializer_amount_after_fee = escrow
            ...
            .unwrap();
        let receiver_amount_after_fee = escrow.receiver_amount.checked_sub(reciever_fee).unwrap();
        ...
        if reciever_fee > 0 {
            ...
            transfer(reciever_fee_ctx, reciever_fee)?;
        }
